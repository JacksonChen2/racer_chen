...
export RACER_ALGORITHM_LABEL=original_racer_bs_round_robin_sionna_rt_relocated_bs
export RACER_LKH_DIR="/tmp/racer_warehouse_loaded_bs_rr_relocated_${run_id}_lkh"
export RACER_RESULT_DIR="${RACER_RESULT_DIR:-${workspace_dir}/experiments/warehouse_loaded_bs_rr_relocated_${run_id}_900s}"
