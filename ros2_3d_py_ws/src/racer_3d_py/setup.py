...
setup(
    ...
    entry_points={
        "console_scripts": [
            "racer_3d_py_agent = racer_3d_py.agent_node:main",
            "racer_3d_py_monitor = racer_3d_py.monitor_node:main",
            "racer_3d_py_mock_sim = racer_3d_py.mock_simulator:main",
        ],
    },
)
