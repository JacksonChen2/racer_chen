...
# Formal Warehouse Loaded fidelity requested for the paired comparison.
...
# The requested camera load runs substantially slower than real time on the
# reference RTX 4060; leave enough wall-clock headroom for all 1800 sim seconds.
...
export RACER_RESULT_DIR="${RACER_RESULT_DIR:-${workspace_dir}/experiments/warehouse_loaded_bs_round_robin_${run_id}}"
