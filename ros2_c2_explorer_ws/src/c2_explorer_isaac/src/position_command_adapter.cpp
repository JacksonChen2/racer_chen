...
class PositionCommandAdapter final : public rclcpp::Node {
 public:
  PositionCommandAdapter() : Node("position_command_adapter") {
    ...
    command_sub_ = create_subscription<c2_explorer_msgs::msg::PositionCommand>(
        prefix + "/position_cmd", rclcpp::QoS(20).reliable(),
        [this](c2_explorer_msgs::msg::PositionCommand::ConstSharedPtr message) {
          command_ = *message;
          command_stamp_ = now();
          have_command_ = true;
        });
 ...
 private:
  ...
  c2_explorer_msgs::msg::PositionCommand command_;
  rclcpp::Subscription<nav_msgs::msg::Odometry>::SharedPtr odom_sub_;
  rclcpp::Subscription<c2_explorer_msgs::msg::PositionCommand>::SharedPtr command_sub_;
