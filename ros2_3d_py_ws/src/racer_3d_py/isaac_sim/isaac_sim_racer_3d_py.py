...
if (PACKAGE_ROOT / "racer_3d_py").is_dir():
...
from racer_3d_py.crazyflie import MASS, velocity_wrench  # noqa: E402
from racer_3d_py.pointcloud import create_xyzi_cloud, read_xyzi_cloud  # noqa: E402
from racer_3d_py.scenario import (  # noqa: E402
    DRONE_RADIUS,
    get_scenario,
    obstacle_clearance,
    pairwise_distances,
...
from racer_3d_py.safety import (  # noqa: E402
...
class IsaacRacer3DBridge(Node):
    def __init__(self, bodies, lidars, contacts) -> None:
        super().__init__("isaac_racer_3d_py_bridge")
        self.bodies = bodies
        self.lidars = lidars
        ...
        self.visual_paths = [
            np.empty((0, 3), dtype=np.float32) for _ in bodies
        ]
        self.visual_trails = [
        ...
        self.metrics_publisher = self.create_publisher(
            String, "/racer_3d_py/sim_metrics", qos
        )
        self.create_subscription(
            String,
            "/racer_3d_py/mission_complete",
    ...
    def _world_points(
        ...
        from racer_3d_py.crazyflie import quaternion_matrix
...
def main() -> None:
    ...
    print(
        f"RACER_3D_PY_ISAAC_READY drones={len(bodies)} "
    ...
    if ARGS.visualize_exploration:
        print(
            "RACER_3D_PY_VISUALIZATION_READY "
