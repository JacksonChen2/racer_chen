...
# Match the formal BS round-robin run so the comparison changes only topology.
...
export RACER_RESULT_DIR="${RACER_RESULT_DIR:-${workspace_dir}/experiments/warehouse_simple_distributed_${run_id}}"
