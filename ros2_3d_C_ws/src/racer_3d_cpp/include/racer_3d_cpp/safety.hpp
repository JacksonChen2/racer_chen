...
Point3 cbfSwarmFilter(const Point3 &preferred, const Point3 &position,
                      ...
                      double alpha = 0.8,
                      double guaranteed_deceleration = 0.6,
                      double response_time = 0.20, int iterations = 6);
...
Point3 pointcloudObstacleFilter(
    ...
    double alpha = 0.8, double guaranteed_deceleration = 0.6,
    double response_time = 0.20, double activation_distance = 2.2,
    std::size_t maximum_constraints = 128, int iterations = 6);
