...
public:
  ...
  // Flood the current known-free connected component once and classify a batch of goals. This
  // avoids hundreds of independent, time-limited A* calls during viewpoint filtering.
  bool searchKnownFreeComponent(const Eigen::Vector3d& start_pt,
...
private:
  ...
  int connectivity_max_nodes_;
  double local_expansion_min_dist_, local_expansion_max_dist_;
