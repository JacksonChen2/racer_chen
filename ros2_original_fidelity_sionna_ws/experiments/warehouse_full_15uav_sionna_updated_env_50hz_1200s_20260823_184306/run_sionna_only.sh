...
suite="${workspace}/experiments/warehouse_full_15uav_sionna_updated_env_50hz_1200s_20260823_184306"
case_dir="${suite}/sionna_distributed_safety_0p12m"
mkdir -p "${case_dir}"
...
export RACER_LKH_DIR="/tmp/racer_warehouse_full_15uav_20260823_184306_sionna_updated_env_lkh"
export RACER_ALGORITHM_LABEL="warehouse_full_15uav_sionna_distributed_updated_env_safety_0p12m_50hz"
