...
void SDFMap::initMap(ros::NodeHandle& nh) {
  ...
  // The ROS1 source reads this field below without ever assigning it.  C2's
  // default/world-frame deployment does not use a separate swarm transform;
  // make that intended branch deterministic instead of depending on heap data.
  mp_->use_swarm_tf_ = false;
